...
async function main() {
    const EXERCISES = [
        ...
        // CARDIO (use modality)
        { name: 'Treadmill Run', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Treadmill', modality: 'Running', description: 'Run on a treadmill at a steady pace.' },
        { name: 'Outdoor Run', category: C.CARDIO, primaryMuscle: M.FULL_BODY, modality: 'Running', description: 'Run outdoors on a track or trail.' },
        { name: 'Stationary Bike', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Bike', modality: 'Cycling', description: 'Pedal on a stationary bike at a moderate intensity.' },
        { name: 'Rowing Machine', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Rower', modality: 'Rowing', description: 'Drive with legs, then pull to ribs; return controlled.' },
        { name: 'Elliptical', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Elliptical', modality: 'Elliptical', description: 'Stride smoothly while pushing/pulling handles.' },
        { name: 'Stair Climber', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Stair Climber', modality: 'Stair Stepper', description: 'Step steadily; stay tall; light hands.' },
        { name: 'Jump Rope', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Rope', modality: 'Jump Rope', description: 'Small, quick hops; turn with wrists.' },
        { name: 'Swimming', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Pool', modality: 'Swimming', description: 'Swim laps with smooth strokes and breathing.' },
        { name: 'Battle Ropes', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Ropes', modality: 'Battle Ropes', description: 'Create waves explosively; athletic stance.' },
        { name: 'Sled Push', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Sled', modality: 'Sled', description: 'Lean forward and drive the sled.' },
        { name: 'Sled Pull', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Sled', modality: 'Sled', description: 'Walk back smoothly while keeping tension.' },
        { name: 'Assault Bike', category: C.CARDIO, primaryMuscle: M.FULL_BODY, equipment: 'Assault Bike', modality: 'Cycling', description: 'Push/pull arms and pedal hard in intervals.' },

        // MOBILITY / COOL DOWN
        { name: 'Hip Flexor Stretch', category: C.MOBILITY, primaryMuscle: M.LOWER_BODY, description: 'Lunge stretch targeting hip flexors.' },
        { name: 'Thoracic Extension on Foam Roller', category: C.MOBILITY, primaryMuscle: M.BACK, equipment: 'Foam Roller', description: 'Foam rolling exercise to improve thoracic spine mobility.' },
